...
## Data and analyses:
The data measures quantitative characteristics of the snowshow hares observed at each field site. Experimental variables include, weight, hind foot length, age, sex, and unique identifiers. Analyses used in the report include graphical representations of relationships, t-tests for variance, and correlation tests. RStudio version 1.3.1073 was used to complete all analyses. 
```{r}
